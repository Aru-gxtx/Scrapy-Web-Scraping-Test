...
def populate_workbook(excel_path, json_entries):
    ...
    for json_item in json_entries:
        ...
        if json_catalog:
            ...
            product_name = normalize_text(json_item.get("product_name") or json_item.get("Product Title"))
...
def main():
    ...
    parser.add_argument(
        "--json",
        default="steelite/goforgreenuk.json",
