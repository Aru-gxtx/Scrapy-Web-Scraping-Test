...
def main():
    parser = argparse.ArgumentParser(
        description=(
            "Populate empty cells in STEELITE.xlsx using wasserstrom_v0.1 scraped data, "
    ...
    parser.add_argument(
        "--json",
        default="steelite/wasserstrom_v0.1.json",
        help="Path to wasserstrom_v0.1 JSON file",
    )
