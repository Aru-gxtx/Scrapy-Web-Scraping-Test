...
def populate_workbook(excel_path, json_entries):
    ...
    for json_item in json_entries:
        # Skip items that were not found or were blocked
...
def main():
    parser = argparse.ArgumentParser(
        description=(
            "Populate empty cells in STEELITE.xlsx using drinkstuff scraped data, "
    ...
    parser.add_argument(
        "--json",
        default="steelite/drinkstuff.json",
        help="Path to drinkstuff JSON file",
    )
